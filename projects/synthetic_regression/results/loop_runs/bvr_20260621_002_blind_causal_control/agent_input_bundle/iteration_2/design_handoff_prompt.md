...
- Loop run id: `bvr_20260621_002_blind_causal_control`
- Condition: `blind`
- Input manifest: `/home/res1235/workspace/agentic-imodels-harness/projects/synthetic_regression/results/loop_runs/bvr_20260621_002_blind_causal_control/agent_input_bundle/iteration_2/input_manifest.json`
- Editable candidate file: `/home/res1235/workspace/agentic-imodels-harness/projects/synthetic_regression/results/loop_runs/bvr_20260621_002_blind_causal_control/workspace/candidate_model.py`
- Primary metric: `cv_rmse_mean`
- Primary metric direction: `minimize`
- Budget: `5`
- Forbidden artifacts for this condition: model_string, interpretability_packet, candidate_snapshot
