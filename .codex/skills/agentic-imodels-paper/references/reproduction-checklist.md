...
- Fixed committed public data files and split.
...
- Candidate design does not inspect or encode benchmark generator code, hidden
  targets, or oracle structure metadata.
